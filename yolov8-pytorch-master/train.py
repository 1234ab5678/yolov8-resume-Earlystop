...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------#
    resume              = True
    resume_model        = './logs/loss_2023_10_25_20_03_21/last_epoch_weights.pth'
    # ------------------------------------------------------------------#
    #   earlystop             是否进行提前终止
    ...
    if True:
        ...
        #----------------------#
        if local_rank == 0:
            eval_callback   = EvalCallback(model, input_shape, class_names, num_classes, val_lines, log_dir, Cuda, resume, \
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            flag = fit_one_epoch(model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir, resume, earlystopping, local_rank)
            if flag:
                break
